...
Your script should create a vector named `permPVal`, each of the entries of this vector should contain the minimum p-value observed in one permutation test. 
