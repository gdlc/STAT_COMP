...
```{r, echo=FALSE,fig.cap="Figure 4: Trace density plots of the error variance.", out.width = '85%'}
  par(mfrow=c(1,2))
  # Trace plot
...
```{r, echo=FALSE,fig.cap="Figure 5: Trace and density plots of the variance of effects.", out.width = '85%'}
  par(mfrow=c(1,2))
  # Trace plot
